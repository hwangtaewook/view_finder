...
import 'package:view_finder/core/firebase_module.dart' as _i13;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.AccountViewModel>(
        () => _i10.AccountViewModel(postRepository: gh<_i8.PostRepository>()));
    gh.factory<_i11.MainViewModel>(
        () => _i11.MainViewModel(postRepository: gh<_i8.PostRepository>()));
