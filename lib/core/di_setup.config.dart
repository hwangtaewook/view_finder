...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i5.UploadMember>(() => _i5.UploadMember());
    gh.singleton<_i6.UserDataSource>(() =>
        _i6.UserDataSource(firebaseFirestore: gh<_i4.FirebaseFirestore>()));
    gh.singleton<_i7.PostDataSource>(() =>
        _i7.PostDataSource(firebaseFirestore: gh<_i4.FirebaseFirestore>()));
